...
// this should be used everywhere you have returned data to client
// example of usage:
// return responseHelper.serverError(request, response, error);
// Or
// return responseHelper.ok(request, response, entries);
